...
Sub Initialization()
  Windowtitle " The Bradley Aberration of Light in the Presence of the Doppler Effect"
  display = "amplitude"
  iteration = 0
  brightness = 1
  x_center = .5 * x_width
...
'    Color white
  ...
  Locate 42, 45:  ? "The source and the main parabola are moving at .5 c. The observer moving"
  Locate 43, 45:  ? "along with them sees the two small parabolas moving in opposite directions"
  Locate 44, 45:  ? "at .33 c. However, their absolute speed is rather given by Poincare's law"
  Locate 45, 45:  ? "of speed addition so that the Earth's orbit is not symmetric any more.";
