...
Sub Initialization()
  Windowtitle " The Bradley Aberration of Light - The Time Scanner corrects the asymmetry"
  display = "amplitude"
  iteration = 0
  brightness = 1
  x_center = .5 * x_width
  ...
  beta_1 = (beta - 1 / 3) / (1 + beta *-1 / 3)                        'small parabolas speed according to Poincaré's
  beta_2 = (beta + 1 / 3) / (1 + beta * 1 / 3)                        '                        ...law of speed addition.
...
'    Color red
    ? " The source parabola is stationary. "
'    Color white
  Else           ? Using " Contraction.. #.####  sqr(1-beta^2)"; g_Lorentz
  End If  
  Locate 44,1:       ? " Lambda......."; lambda / scale; " pixels (wavelength)"
  Locate 42, 47:  ? "This is the ultimate experiment. It shows that the moving observer is"
  Locate 43, 47:  ? "fooled by the Doppler effect. The Time Scanner replaces the situation"
  Locate 44, 47:  ? "the way he is seeing it. The symmetry still seems perfect to his eyes."
  Locate 45, 47:  ? "Clearly, Relativity is all about mystification!";
