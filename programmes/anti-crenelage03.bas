...
color 0, fond: cls
locate 1, 1 : print " LE PRINCIPE DE HUYGENS"
...
locate, 4: print "sup‚rieur … ceux qui font appel … une interpolation de type bicubique parce qu'il am‚liore"
locate, 4: print "la r‚solution au lieu de provoquer un flou. Il devrait ˆtre plus complexe pour traiter"
locate, 4: print "efficacement une image en couleurs normale, mais tout indique que c'est possible."
?
locate, 4: print "Code source FreeBASIC, 16 nov. 2005."
