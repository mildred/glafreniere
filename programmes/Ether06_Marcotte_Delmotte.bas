...
'   amplitudeDroite = gabarit*(Cos(t)*Sin(x)-Sin(t)*(1-Cos(x)))/x'formules de Jocelyn Marcotte.
    amplitudeDroite = gabarit*(Sin(t+x)-Sin(t))/x         'simplification par Philippe Delmotte.
    amplitudeGauche = gabarit*(Sin(-t+x)-Sin(-t))/x
...
Color noir, fond
Locate 2, 5:?"LES ONDES PROGRESSIVES DE L'ELECTRON"
...
Locate 35,61:?"M. Philippe Delmotte a simplifi‚ en"
Locate 36,61:?"septembre 2006:"
...
Locate 35,3:?"Le 25 sept. 2006. Ce programme peut ˆtre";
