...
Locate 32,3:  ?"Le noir indique les zones o— l'amplitude est nulle; le blanc, celles o— elle est trŠs grande."
Locate 33,3:  ?"Zoom: appuyez sur + ou - . Lambda ="; lambda; " pixels."
Locate 34,3:  ?"Vitesse normalis‚e: appuyez sur un chiffre de 1 … 9. Bˆta = ";: Print Using "#.#"; beta;
...
Locate 36,39: ?"Ce programme FreeBASIC peut ˆtre copi‚, modifi‚ ou distribu‚."
Locate 37,39: ?"Gabriel LaFreniŠre, le 14 octobre 2006.  glafreniere.com";
Pcopy 2, page1
Return
