...
Locate 47,89: Print "April 18, 2008. This program may be"
...
Locate 10,3:  Print "simplified algorithm using Euler's"
Locate 11,3:  Print "method. The sine error is asymmetric"
...
Locate 26,3:  Print "becomes symmetrical. The sine and "
Locate 27,3:  Print "cosine error is still severe. The"
Locate 28,3:  Print "accurate step is given by:        "
Locate 30,3:  Print "       2 * sin(pi / lambda)       "

Locate 33,3:  Print "          DIAGRAM 3"
Locate 35,3:  Print "The goal is to correct the sine error."
Locate 36,3:  Print "Mr. Jocelyn Marcotte found in April   "
Locate 37,3:  Print "2008 that this can be achieved by     "
Locate 38,3:  Print "initializing the cosine this way:"
Locate 40,3:  Print "      cosine = Cos(step / 2)"
Locate 42,3:  Print "The cosine offset (1.5"; Chr(248);" instead of 1)  "
Locate 43,3:  Print "is a minor problem because values can "
Locate 44,3:  Print "be deduced from sine using Pythagoras'"
