...
' Circle(x_coord,y_center),.5*(x_C-x_A)/g_Lorentz,white,,, 1/g_Lorentz'expanding ellipsoid mirror.
  ...
  For x = -radius To radius                                           'printing the blue galaxies.
    For y = -radius To radius                                         'scanning x and y, one pixel at a time.
      If x_y(x, y) Then                                               'copying the matrix blue color only when x_y(x, y) code = 1.
        ...
        beta_y = 0                                                    'horizontal central row.
        beta_x = beta_1
        Print_Galaxy()
        beta_x = beta_2
        Print_Galaxy()
        ...
        beta_x = .45                                                  'ellipse intersection point.
        beta_y = beta_1
        Print_Galaxy()
        beta_x = .75
        Print_Galaxy()
  ...
  Locate 1, 1:  ? "C"                                                 'axial galaxy C identification.
  ...
  Locate 1, 1:  ? "B"                                                 'axial galaxy B identification.
